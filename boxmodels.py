...
class BoxModel:
  """ 
  This class defines a model of the box, 
  it contains information on the type of box,
...
def get_model(type):
  """ 
  This function is used to select the model of a box in 
  function of a number.
  It is mostly used when initializing the boxes from the 
